...
namespace icp_logicapp.Tests
{
    public class TestExecutor
    {
        ...
        public TestExecutor(string configPath)
        {
            ...
            // Set environment variable to indicate we're running in an App Service environment
            // This allows the test framework to accept managed identity authentication
            Environment.SetEnvironmentVariable("WEBSITE_SITE_NAME", "icp-logicapp-test");
            Environment.SetEnvironmentVariable("APP_KIND", "workflowapp");
            Environment.SetEnvironmentVariable("Workflows.Standalone.Hosting.Version", "2");
        }
