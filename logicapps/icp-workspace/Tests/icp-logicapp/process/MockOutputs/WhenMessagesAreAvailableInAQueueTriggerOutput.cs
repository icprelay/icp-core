...
{
    /// <summary>
    /// The <see cref="WhenMessagesAreAvailableInAQueueTriggerMock"/> class.
    /// </summary>
    public class WhenMessagesAreAvailableInAQueueTriggerMock : TriggerMock
    {
        /// <summary>
        /// Creates a mocked instance for  <see cref="WhenMessagesAreAvailableInAQueueTriggerMock"/> with static outputs.
        /// </summary>
        public WhenMessagesAreAvailableInAQueueTriggerMock(TestWorkflowStatus status = TestWorkflowStatus.Succeeded, string name = null, WhenMessagesAreAvailableInAQueueTriggerOutput outputs = null)
            : base(status: status, name: name, outputs: outputs ?? new WhenMessagesAreAvailableInAQueueTriggerOutput())
        {
        }

        /// <summary>
        /// Creates a mocked instance for  <see cref="WhenMessagesAreAvailableInAQueueTriggerMock"/> with static error info.
        /// </summary>
        public WhenMessagesAreAvailableInAQueueTriggerMock(TestWorkflowStatus status, string name = null, TestErrorInfo error = null)
            : base(status: status, name: name, error: error)
        {
        }

        /// <summary>
        /// Creates a mocked instance for <see cref="WhenMessagesAreAvailableInAQueueTriggerMock"/> with a callback function for dynamic outputs.
        /// </summary>
        public WhenMessagesAreAvailableInAQueueTriggerMock(Func<TestExecutionContext, WhenMessagesAreAvailableInAQueueTriggerMock> onGetTriggerMock, string name = null)
    ...
    /// <summary>
    /// Class for WhenMessagesAreAvailableInAQueueTriggerOutput representing an object with properties.
    /// </summary>
    public class WhenMessagesAreAvailableInAQueueTriggerOutput : MockOutput
    {
        public HttpStatusCode StatusCode {get; set;}

        public WhenMessagesAreAvailableInAQueueTriggerOutputBody Body { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="WhenMessagesAreAvailableInAQueueTriggerOutput"/> class.
        /// </summary>
        public WhenMessagesAreAvailableInAQueueTriggerOutput()
        {
            this.StatusCode = HttpStatusCode.OK;
            this.Body = new WhenMessagesAreAvailableInAQueueTriggerOutputBody();
        }
    }
    /// <summary>
    /// Class for WhenMessagesAreAvailableInAQueueTriggerOutputBody representing an object with properties.
    /// </summary>
    public class WhenMessagesAreAvailableInAQueueTriggerOutputBody
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WhenMessagesAreAvailableInAQueueTriggerOutputBody"/> class.
        /// </summary>
        public WhenMessagesAreAvailableInAQueueTriggerOutputBody()
        {
